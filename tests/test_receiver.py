...
def test_get_all_users_no_groups():
    # fmt: off
    expected = {'schemas': ['urn:ietf:params:scim:api:messages:2.0:ListResponse'], 'Resources': [{'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'admin', 'userName': 'admin'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'alice', 'userName': 'alice'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'bob', 'userName': 'bob'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'jane', 'userName': 'jane'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'john', 'userName': 'john'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'nextcloud', 'userName': 'nextcloud'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user1', 'userName': 'user1'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user2', 'userName': 'user2'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user3', 'userName': 'user3'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user4', 'userName': 'user4'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user5', 'userName': 'user5'}, {'schemas': ['urn:ietf:params:scim:schemas:core:2.0:User'], 'id': 'user6', 'userName': 'user6'}]}
    # fmt: on
